...
public class FormLogBase : LogBase
{
    ...
    public override string GetLogType() => "FormLogBase";
}

public class FormChangeLogNameModel : FormLogBase
{
    public override string GetLogType() => "FormChangeLogNameModel";
}
...
public class FormChangeTemplateNameModel : FormChangeLogNameModel
{
    ...
    public override string GetLogType() => "FormChangeTemplateNameModel";
}
...
public class FormChangeActionToUserModel : FormChangeLogNameModel
{
    ...
    public override string GetLogType() => "FormChangeActionToUserModel";
}
...
public class FormChangeReassignActionModel : FormChangeLogNameModel
{
    ...
    public override string GetLogType() => "FormChangeReassignActionModel";
}
